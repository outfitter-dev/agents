...
description: Graphite stack workflows for trunk-based development with stacked PRs. Use when working with gt commands, creating/managing stacks, reorganizing branches, submitting PRs, or when Graphite, stacked PRs, or gt is mentioned.
version: 1.0.0
metadata:
  author: outfitter
