...
description: GitButler stacked branch workflows using the --anchor flag for dependent features and reviewable PR breakdown. Use when creating stacks, dependent branches, or when stack, stacked branches, or `--anchor` are mentioned with GitButler.
version: 1.0.0
metadata:
  author: outfitter
