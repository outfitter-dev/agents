...
description: Coordinate multiple AI agents working concurrently using GitButler's virtual branch model. Use when coordinating parallel agents, agent handoffs, or when multi-agent, concurrent agents, or parallel agents are mentioned with GitButler.
version: 1.0.0
metadata:
  author: outfitter
...
- [gitbutler-virtual-branches](../gitbutler-virtual-branches/SKILL.md) — core GitButler workflows
- [gitbutler-stacks](../gitbutler-stacks/SKILL.md) — stacked branches
- [multi-agent-vcs](../multi-agent-vcs/SKILL.md) — tool-agnostic multi-agent policy
