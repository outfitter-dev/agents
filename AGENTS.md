...
- Plugin folders: `baselayer/`, `claude-dev/`, `guardrails/`, `gitbutler/`. Each holds its own `.claude-plugin/plugin.json` plus `skills/`, `commands/`, and (where needed) `agents/` or `templates/`.
