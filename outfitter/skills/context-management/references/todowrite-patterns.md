...
- [ ] [engineer] Implementation phase (after research)
- [ ] [reviewer] Review phase (after impl)
...
```
- [ ] [reviewer] Security review auth module (agent-id: abc123, background)
...
```
- [x] [reviewer] Security review auth module (agent-id: abc123) → 2 issues found
- [x] [analyst] Impact analysis (agent-id: def456) → 3 files affected
- [ ] Address security issues from reviewer
```
