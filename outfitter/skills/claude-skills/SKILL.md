...
name: claude-skills
version: 1.0.0
description: Claude Code-specific skill development guidance. Use when creating skills for Claude Code, setting up tool restrictions, testing with --debug, or troubleshooting skill activation. Loads skills-dev for cross-platform foundation.
metadata:
  related-skills:
    - skills-dev
    - claude-plugins
...
Claude Code-specific implementation details for Agent Skills. For cross-platform concepts (structure, frontmatter, validation), load the **skills-dev** skill first.
...
Users can then invoke with `/code-review` instead of waiting for auto-activation.
...
- [skills-dev](../skills-dev/SKILL.md) - Cross-platform skill structure and validation
