...
Load `dev-typescript/SKILL.md` for TypeScript-specific implementations.
</type_safety>
...
Senior developer skill provides the "why" and "when".
...
**Core Practices:**
- [tdd/SKILL.md](../tdd/SKILL.md) — test-driven development
...
- [dev-typescript/SKILL.md](../dev-typescript/SKILL.md) — TypeScript patterns, Zod, modern features
- [dev-react/SKILL.md](../dev-react/SKILL.md) — React 18-19 patterns, hooks typing
- [dev-hono/SKILL.md](../dev-hono/SKILL.md) — Hono API framework patterns
- [dev-bun/SKILL.md](../dev-bun/SKILL.md) — Bun runtime APIs, SQLite, testing
