...
1. Identify: Spot repeatable behavior in conversation
   - For deep analysis, load [analysis](../analysis/SKILL.md) skill and use [pattern-analysis](../analysis/references/pattern-analysis.md) techniques
...
<references>
- [analysis](../analysis/SKILL.md) — core analysis methodology
- [pattern-analysis](../analysis/references/pattern-analysis.md) — signal extraction techniques
