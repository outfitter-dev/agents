...
- "quick check" / "pre-commit" / etc. → Skill tool: **baselayer:code-review** (quick pass mode)
- "thorough review" / "audit" / "PR review" → Skill tool: **baselayer:code-review** (standard or thorough mode)
- security / auth / vulnerabilities / OWASP → Skill tool: **baselayer:security-engineering**
- performance / slow / optimize / bottleneck → Skill tool: **baselayer:performance-engineering**
- architecture / design / scalability / tech choice → Skill tool: **baselayer:software-architecture**
...
1. Start with primary skill (usually **baselayer:code-review**)
